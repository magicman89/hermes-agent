...
# Railway supplies the persistent /opt/data mount through service volume config.
# Do not declare Docker VOLUME here because Railway CLI uploads reject VOLUME.
